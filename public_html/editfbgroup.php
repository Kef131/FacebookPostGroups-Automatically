...
<form action="existingfbgroups.php" method="post" style="margin:0; padding:0" name="fbpageform">
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablenowidth" align="center">
<tr>
<td height="25" colspan="2" class="headerform">Editar Grupos de Facebook</td>
</tr>
<tr>
...
<tr>
<td class="admineditbox">Asociado con la cuenta:</td>
...
<input type="button" class="submit" value="Actualizar Grupo" style="width:120px" onClick="createnewfbgroup()"></td>
