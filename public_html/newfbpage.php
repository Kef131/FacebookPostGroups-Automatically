...
<html>
<head>
<title>PGF :: Nueva Fan Page</title>
...
<tr>
<td height="25" colspan="2" class="headerform">Crear nueva p&aacute;gina de Facebook</td>
</tr>
<tr>
...
<tr>
<td class="admineditbox">Asociada a la cuenta:</td>
...
<input type="hidden" name="addnewpage" value="yes">
<input type="button" class="submit" value="Crear Fan Page" style="width:120px" onClick="createnewfbpage()"></td>
<td class="admineditbox">Encuentra el ID de la p&aacute;gina aqu&iacute; : <a href="facebook_ID.php" target="_blank" style="color:#900; font-size:13px; font-weight:bold">CLIC AQU&Iacute;</a></td>
</tr>
</table>
</form>
</td>
